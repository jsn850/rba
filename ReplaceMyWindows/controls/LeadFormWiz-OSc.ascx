...
CodeBehind="LeadFormWiz-OSc.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormWiz_OSc" %>
<asp:HiddenField
  id="leadid_token"
  value=""
  runat="server"
...
<div class="forms pt-3 pb-3 py-md-7">
  <div class="form-step active">
    <div class="form-step-container">
      <div id="Step1" class="step-loader">
    ...
    <div class="form-step-container">
      ...
      <div class="form-step-controls px-1 px-md-5">
        ...
        <asp:Button
          ...
          OnClientClick="disableBtnAddressCheck(this); gtag('event','click',{'event_category':'WizOS','event_label':'WizOSAddress-Submit'});"
        />
      </div>
