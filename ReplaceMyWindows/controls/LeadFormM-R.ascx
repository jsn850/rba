<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormM-R.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormM_R" %>
<asp:HiddenField id="leadid_token"  value="" runat="server" ClientIDMode="Static"/>

            <!-- START FORM -->
            <div class="forms pt-3 pb-5 py-md-5">

                <div class="form-step active">
                    <div  class="form-bg-image" id="fbg1" runat="server"><img id="imgstep1" runat="server" src="../img/rba-m-hero-ext-1.jpg"></div>
                    <div class="form-step-container">
                         <div class="step-loader"><img src="images/loader-5step-2.png" width="80%" alt="20%"></div>
                ...
                <asp:CustomValidator ID="CustomValidatorZip" runat="server"    ControlToValidate="txtZipCode" Display="Dynamic" CssClass="form-error"   ValidationGroup="Group1" errormessage="Invalid ZipCode Entered" 
                    ClientValidationFunction="isValidZip"  EnableClientScript="true" ValidateEmptyText="false" ClientIDMode="Static" />
	                    ...
	                    <asp:Button runat="server" ValidationGroup="Group1" class="col btn btn-primary btn-next" Text="START FREE QUOTE" onClientClick ="CheckZipShowAppt();"  ></asp:Button><span class="arrow"></span>
                ...
                <div class="form-step">
                    <div class="form-bg-image"><img id="imgstep3" runat="server" src="../img/rba-m-hero-1.jpg"></div>
                    <div class="form-step-container">
	                    <div class="step-loader"><img src="images/loader-5step-3.png" width="80%"></div>
                ...
                <div class="form-step">
                    <div class="form-bg-image"  ><img id="imgstep5" runat="server" src="../img/rba-m-hero-5.jpg"></div>
                    <div class="form-step-container">
						<div class="step-loader"><img src="images/loader-5step-4.png" width="80%" alt="40%"></div>
                ...
                <div class="form-step">
                    <div class="form-bg-image"><img id="imgstep6" runat="server" src="../img/rba-m-hero-3.jpg"></div>
                    <div class="form-step-container">
	                    <div class="step-loader"><img src="images/loader-5step-5.png" width="80%" alt="60%"></div>
