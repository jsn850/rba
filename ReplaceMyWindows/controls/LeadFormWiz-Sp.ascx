<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormWiz-Sp.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormWiz_Sp" %>
<asp:HiddenField id="leadid_token"  value="" runat="server" ClientIDMode="Static"/>
 <!-- START FORM -->
            <div class="forms pt-3 pb-3 py-md-7 px-md-4">

                <div class="form-step active">
                         <div id="Step1" runat="server" class="step-loader"><img src="images/loader-4stepc-1.png" width="80%" alt="20%"></div>
                         <div class="form-step-title" id="ZipTitleDiv" runat="server">Where is your window project?</div>
                        <div class="form-step-controls mx-auto px-md-5">
                ...
                <asp:CustomValidator ID="CustomValidatorZip" runat="server"    ControlToValidate="txtZipCode" Display="Dynamic" CssClass="form-error"   ValidationGroup="Group1" errormessage="Invalid ZipCode Entered" 
                    ClientValidationFunction="isValidZip"  EnableClientScript="true" ValidateEmptyText="false" ClientIDMode="Static" />
	                    ...
	                    <asp:Button runat="server" ValidationGroup="Group1" class="col btn btn-primary btn-next controlBtn" Text="START FREE QUOTE" onClientClick ="CheckZipShowAppt(); gtag('event','click',{'event_category':'Wiz','event_label':'WizZipcode'});"   ></asp:Button><span class="arrow"></span>
                        </div>
                </div>
                
                
                <div class="form-step">      
	                    <div id="Step2" runat="server" class="step-loader"><img src="images/loader-4stepc-2.png" width="80%"></div>
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Last Name is required." ValidationGroup="Group2"
                            ...
                            <button class="col mr-2 btn btn-light btn-back controlBtn">Back</button>
                            <asp:Button runat="server" ValidationGroup="Group2" class="col btn btn-primary btn-next controlBtn" Text="NEXT" OnClientClick ="gtag('event','click',{'event_category':'Wiz','event_label':'WizName'});" ></asp:Button><span class="arrow"></span>
                            </div>
                        </div> 
                        </div>
                ...
                <div class="form-step">
                    <div class="form-step-container">
						<div id="Step3" runat="server" class="step-loader"><img src="images/loader-4stepc-3.png" width="80%" alt="40%"></div>
                        ...
                        <div class="input-with-icon">
                            ...
                            <asp:Button runat="server" ValidationGroup="Group3" class="col btn btn-primary btn-next controlBtn" Text="NEXT" OnClientClick ="gtag('event','click',{'event_category':'Wiz','event_label':'WizContactInfo'});" ></asp:Button><span class="arrow"></span>
                        </div> 
                            </div>
                ...
                <div class="form-step">
                    <div class="form-step-container">
	                    <div id="Step4" runat="server" class="step-loader"><img src="images/loader-4stepc-4.png" width="80%" alt="60%"></div>
                        <div class="form-step-title" id="LastStepTitle">What is your home address?</div>
                        <div class="form-step-controls px-1 px-md-5">
                          <div class="input-with-icon">
                               ...
                               <div id="apptwrapper" style="display: none;">
                                     <asp:DropDownList runat="server" ID="DDlApptTime" CssClass="form-control" ValidationGroup="">
                                      <asp:ListItem Text="Preferred Appointment Date/Time" Value=""></asp:ListItem>
                            ...
                            <div class="btnRow">
                                ...
                                <button class="mr-2 btn btn-light btn-back controlBtn">Back</button>

                            <asp:Button runat="server" ID="btnSubmit" Text="Get Started Now" CssClass="col btn btn-primary btn-next controlBtn" OnClick="btnSubmit_Click" ValidationGroup="Group4" UseSubmitBehavior="false" OnClientClick="disableBtnAddresscheck(this); gtag('event','click',{'event_category':'Wiz','event_label':'WizAddress-Submit'});"  />
