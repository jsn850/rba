...
CodeBehind="LeadFormLPF-OS.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormLPF_OS" %>
<asp:HiddenField
  id="leadid_token"
  value=""
  runat="server"
    ...
    <div class="input-container single">
      <div class="input-col">
        ...
        <asp:Button
          ...
          CssClass="btn-next button"
          OnClick="btnSubmit_Click"
          ValidationGroup="Group4"
          CausesValidation="true"
          UseSubmitBehavior="false"
          OnClientClick="return handleClientClick('Group4', 'LPF');"
        />
