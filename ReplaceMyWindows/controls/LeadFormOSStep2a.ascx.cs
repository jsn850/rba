...
{
    public partial class LeadFormOSStep2a : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                catch (Exception osex2)
                {
                    ...
                    Response.Redirect("Rbaw40-OSa.aspx");  //redirect to step 1 if we dont have leadid or intial insert fails
                }
            }
        ...
        protected void btnAddtlQuest_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Rbaw40-OS3c.aspx");
            }
        }
    }
}