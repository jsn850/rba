...
CodeBehind="LeadFormOSStep2b.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormOSStep2b" %>
...
<!-- START FORM -->
<div class="forms pt-3  py-md-7" style="background: transparent;">
  <%--
  <div
    ...
    <div class="form-step-container">
      ...
      <div style="max-width: 300px; margin: auto">
        <asp:Button
          ...
          Text="NEXT"
          OnClientClick="setTimeout(disableBtnStep2,1); startLoader(); gtag('event','click',{'event_category':'WizOS','event_label':'OnlineScheduleStep2'});"
