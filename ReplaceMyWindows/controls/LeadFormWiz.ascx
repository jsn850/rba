...
CodeBehind="LeadFormWiz.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormWiz" %>
<asp:HiddenField
  id="leadid_token"
  value=""
  runat="server"
      ...
      <div class="form-step-controls mx-auto">
        ...
        <div class="form-step-actions mx-auto style='width: 100%'">
          <asp:Button
            ...
            onClientClick="CheckZipShowAppt(); gtag('event','click',{'event_category':'Wiz','event_label':'WizZipcode'}); gtag('event', 'zip_code_entered');"
          ></asp:Button
    ...
    <div class="form-step-container">
      ...
      <div class="form-step-actions row no-gutters px-3 px-md-5">
        ...
        <asp:Button
          ...
          class="col btn btn-primary btn-next"
          Text="NEXT"
          OnClientClick="gtag('event','click',{'event_category':'Wiz','event_label':'WizName'}); gtag('event', 'user_name_entered');"
        ></asp:Button
        ><span class="arrow"></span>
      </div>
    </div>
      ...
      <div class="form-step-actions row no-gutters px-3 px-md-5">
        ...
        <asp:Button
          ...
          OnClientClick="gtag('event','click',{'event_category':'Wiz','event_label':'WizContactInfo'}); 
            gtag('event', 'phone_email_entered');"
        ></asp:Button
        ><span class="arrow"></span>
      </div>
    </div>
    ...
    <div class="form-step-container">
      ...
      <div class="form-step-controls px-1 px-md-5">
        ...
        <asp:Button
          ...
          OnClientClick="disableBtnAddresscheck(this); gtag('event','click',{'event_category':'Wiz','event_label':'WizAddress-Submit'}); gtag('event', 'address_entered');"
        />
        </div>
      </div>
