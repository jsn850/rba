...
CodeBehind="LeadFormWizOStest.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormWizOStest" %>
...
<script>
    ...
    function handleClientClick() {
      if (Page_ClientValidate("LeadFormWizc")) {
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if (response) {
                ...
                $("#LeadForm1_btnSubmit").prop("disabled", true)
                $("#LeadForm1_btnSubmit").addClass("disabled-btn")
                startLoader()

                // Submit the form after successful reCAPTCHA verification
                __doPostBack("<%= btnSubmit.ID %>", "")

                disableBtnAllCheck($("#LeadForm1_btnSubmit"))

                gtag("event", "click", {
                  event_category: "WizOS",
                  event_label: "WizOSAddress-Submit"
                })
                gtag("event", "click", {
                  event_category: "WizOS",
                  event_label: "WizOSZip"
                })
                gtag("event", "click", {
                  event_category: "WizOS",
                  event_label: "WizOSName"
                })
                gtag("event", "click", {
                  event_category: "WizOS",
                  event_label: "WizOSContactInfo"
                })
              } else {
  ...
  <div class="input-container-single">
    ...
    <div class="input-row">
      ...
      <div class="input-col">
        ...
        />
         ...
         <p class="recaptcha-form-error">Please click the I’m not a robot checkbox to continue.</p>
         </div>
    ...
    <div class="form-step-actions btn-row mt-3">
      <asp:Button
        ...
        OnClientClick="return handleClientClick('LeadFormWizc');"
      >
      </asp:Button>
    </div>
