<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormPella.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormPella" %>
...
<%-- <div class="field med">
 ...
 <div class="disclaimer">
  ...
  <p id="tcpa" runat="server">
   By pressing the Get Started Now button above, you acknowledge that you’d like to learn more about Pella windows. You also authorize Pella to call and/or email you at the phone number(s)/email address(es) above, including your wireless number if provided, with automated technology in order to schedule a convenient day and time. If you live in a territory where Pella is not currently working with <span id ="DiscDomain" runat="server">ReplaceMyWindows4Less.com</span> or that is not serviced by Pella, we will send your information to up to four home improvement companies that can help with your project. You acknowledge that you are submitting this form so that you can be contacted and informed about products, services and sales. You understand that you do not need to submit this form to schedule an in-home price quote. If you do not wish to provide us with this consent, you may contact us directly at 1-646-588-5009
  </p>
     </label>
 </div>
</div>
