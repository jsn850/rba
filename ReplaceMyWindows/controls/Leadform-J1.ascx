<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Leadform-J1.ascx.cs" Inherits="ReplaceMyWindows.controls.Leadform_J1" %>
<asp:HiddenField id="leadid_token"  value="" runat="server" ClientIDMode="Static"/>


                <div class="form-step active">
                    <div  class="form-bg-image" id="fbg1" runat="server"><img id="imgstep1" runat="server" src="../img/hero1-j.jpg"></div>
                ...
                <div class="form-step">
                    <div class="form-bg-image"><img id="imgstep3" runat="server" src="../img/hero2-j.jpg"></div>
                    <div class="form-step-container">
                ...
                <div class="form-step">
                    <div class="form-bg-image"  ><img id="imgstep5" runat="server" src="../img/hero3-j.jpg"></div>
                    <div class="form-step-container">
                ...
                <div class="form-step">
                    <div class="form-bg-image"><img id="imgstep6" runat="server" src="../img/hero6-j.jpg"></div>
                    <div class="form-step-container">
