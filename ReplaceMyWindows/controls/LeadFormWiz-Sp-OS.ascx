...
CodeBehind="LeadFormWiz-Sp-OS.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormWiz_Sp_OS" %>
<asp:HiddenField
  id="leadid_token"
  value=""
  runat="server"
...
<div class="forms pt-3 pb-3 py-md-7 px-md-4">
  <div class="form-step active">
    <div id="Step1" runat="server" class="step-loader">
      <img data-src="images/loader-4stepc-1.png" width="80%" alt="20%" />
    </div>
    ...
    <div class="form-step-controls mx-auto px-md-5">
      ...
      <asp:Button
        runat="server"
        ValidationGroup="Group1"
        class="col btn btn-primary btn-next controlBtn"
  ...
  <div class="form-step">
    <div id="Step2" runat="server" class="step-loader">
      <img data-src="images/loader-4stepc-2.png" width="80%" />
    </div>
  ...
  <div class="form-step">
    <div class="form-step-container">
      <div id="Step3" runat="server" class="step-loader">
        <img data-src="images/loader-4stepc-3.png" width="80%" alt="40%" />
      </div>
      ...
      <div class="form-step-controls px-3 px-md-5">
        ...
        <div class="btnRow">
          <button class="col mr-2 btn btn-light btn-back controlBtn">
            Back
          </button>
  ...
  <div class="form-step">
    <div class="form-step-container">
      <div id="Step4" runat="server" class="step-loader">
        <img data-src="images/loader-4stepc-4.png" width="80%" alt="60%" />
      </div>
      ...
      <div class="form-step-controls px-1 px-md-5">
        ...
        <div class="btnRow">
          ...
          <asp:Button
            ...
            CssClass="col btn btn-primary btn-next controlBtn"
            OnClick="btnSubmit_Click"
            ValidationGroup="Group4"
            UseSubmitBehavior="false"
            OnClientClick="return handleClientClick('Group4', 'SP');"
          />
        </div>
      </div>
