<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormWizEX.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormWizEX" %>
            ...
            <div class="forms pt-3 pb-3 py-md-7">
                ...
                <asp:CustomValidator ID="CustomValidatorZip" runat="server"    ControlToValidate="txtZipCode" Display="Dynamic" CssClass="form-error"   ValidationGroup="Group1" errormessage="Invalid ZipCode Entered" 
                    ClientValidationFunction="isValidZip"  EnableClientScript="true" ValidateEmptyText="false" ClientIDMode="Static" />
	                    ...
	                    <asp:Button runat="server" ValidationGroup="Group1" class="col btn btn-primary btn-next" Text="START FREE QUOTE"   ></asp:Button><span class="arrow"></span>
...
<%--                               <div id="apptwrapper" style="display: none;">
                       ...
                       <div class="tcpa mt-10">
                                      <p id="tcpa" runat="server" >
                                            By pressing the Get Started Now button above, you acknowledge that you’d like to learn more about Replacement windows. You also authorize ExpertWindows.com Partners or any third-party <a href="partners.html" target="_blank">organization</a> to call,  SMS and/or email you at the phone number(s)/email address(es) above, including your wireless number if provided, with automated technology in order to schedule a convenient day and time. If you live in a territory where ExpertWindows.com Partners are not currently working, we will send your information to up to four home improvement companies that can help with your project. You acknowledge that you are submitting this form so that you can be contacted via email, phone or text message and informed about products, services and sales, as well as third-party offers including, without limitation, from our affiliates and/or unrelated third parties. You understand that you do not need to submit this form to schedule an in-home price quote. If you do not wish to provide us with this consent, you may contact us directly at (516) 253-6644  
                                      </p>	
                            </div>                               
<%--                        <div class="form-step-actions row no-gutters px-3 px-md-5">--%>
