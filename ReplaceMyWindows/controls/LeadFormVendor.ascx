<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormVendor.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormVendor" %>
<div class="frm">
 <div class="field lng">
  <label class="lbl">
   First Name</label>
 ...
 <div class="field med">
  <label class="lbl">
   Lead Id</label>
  <asp:TextBox runat="server" Text="" CssClass="txt" ID="TxtLeadID" MaxLength="50" ValidationGroup="LeadForm"></asp:TextBox>
  <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Leadid is required." ValidationGroup="LeadForm"
   ControlToValidate="TxtLeadID" Display="Dynamic" CssClass="req" InitialValue=""></asp:RequiredFieldValidator>
 </div>
 <div class="required">
  <p>
