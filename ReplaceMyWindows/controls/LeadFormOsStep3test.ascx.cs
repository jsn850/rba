...
{
    public partial class LeadFormOsStep3test : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch
            {
                ...
                Response.Redirect("Rbaw40-OStest.aspx");  //redirect to step 1 if we dont have a Session apptimes
            ...
            try
            {
                ...
                if (Convert.ToString(Session["Submissionid"]) == "-1" || Session["Submissionid"] == null)
                {
                    ...
                    Response.Redirect("Rbaw40-OStest.aspx");  //redirect to step 1 if Submissionid =-1,  meaning user completed and tried ot come back
                }
            }
            catch
            {
                ...
                Response.Redirect("Rbaw40-OStest.aspx");  //redirect to step 1 if we dont have a sessionid
            ...
            catch (Exception OS3Pageex)
            {
                ...
                Response.Redirect("Rbaw40-OStest.aspx");  //redirect to step 1 if we dont have correct session info
            }
        ...
        protected void btnSetAppt_Click(object sender, EventArgs e)
        {
            ...
            //        bool isValidCaptcha = VerifyCaptcha(recaptchaResponse);

            //        if (isValidCaptcha)
            //        {
            //            RecaptchaError.Visible = false;
                        ...
                        else
                        {
                            ...
                            catch (Exception Apptset)
                            {
                                ...
                                Response.Redirect("Rbaw40-OStest.aspx");  //redirect to step 1
                            }

                            if (AppointmentDateTime == "")
                            {
                                f.saveResponseLog("OSPage3ApptError Appt Date empty");
                                Response.Redirect("Rbaw40-OS3test.aspx");  //redirect to step 3c
                            }
                            ...
                            if (response.Contains("not available"))
                            {
                                ...
                                Response.Redirect("Rbaw40-OS3test.aspx?message=NotAvailable");
                            }
        ...
        //private bool VerifyCaptcha(string recaptchaResponse)
        //{
        //    string PrivateKey = "6Ldn8yMnAAAAALTvCwoLw5ANXZ8q0LkujRfVI526";

        //    using (var client = new WebClient())
        //    {
        //        string verifyUrl = $"https://www.google.com/recaptcha/api/siteverify?secret={PrivateKey}&response={recaptchaResponse}";
        ...
        protected void Calendar3_DayRender(object sender, DayRenderEventArgs e)
        {
            ...
            {
                f.saveResponseLog("OSPage3ApptSetError:" + apptsetex.Message);
                Response.Redirect("Rbaw40-OS3test.aspx");  //redirect to step 3 drop down versions if we have an error
