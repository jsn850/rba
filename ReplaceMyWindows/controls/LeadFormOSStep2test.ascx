...
CodeBehind="LeadFormOSStep2test.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormOSStep2test" %>
...
<script>
    ...
    function disableBtnStep2() {
        document.getElementById("LeadForm1_step2next").disabled = "true"
        $(".btn-next").addClass("disabled-btn")
    }

    function handleFormFunctions() {
        startLoader();
        setTimeout(disableBtnStep2, 1);
        gtag('event', 'click', { 'event_category': 'WizOS', 'event_label': 'OnlineScheduleStep2' });
    }

    function handleClientClick() {
        let numWindows = $('#howmanywindowsdoors').val()
        let numDoors = $('#howmanydoors').val()
        ...
        if (numWindows == 0 && numDoors == 0) {
            $('.error-container').css('display', 'block')
            $('.form-error-div').css('display', 'block')

            return false
        } else {
            $('.error-container').css('display', 'none')
            $('.form-error-div').css('display', 'none')
    ...
    <div class="form-step-controls pb-3 pr-2">
      ...
      <div class="form-step-controls pb-3">
        <h4>
          ...
          <div class="error-container" style="font-size: 1.25em; color: red; text-align: center; display: none;">
              <p >Please select a number of windows AND/OR doors.</p>
          </div>
      ...
      <div>
        <div class="form-error-div" style="font-size: 1.25em; color: red; text-align: center; display: none;">
