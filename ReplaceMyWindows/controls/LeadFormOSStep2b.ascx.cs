...
{
    public partial class LeadFormOSStep2b : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                catch (Exception osex2)
                {
                    ...
                    Response.Redirect("Rbaw40-OSb.aspx");  //redirect to step 1 if we dont have leadid or intial insert fails
                }
            }
        ...
        protected void btnAddtlQuest_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Rbaw40-OS3d.aspx");
            }
        }
    }
}