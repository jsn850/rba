...
CodeBehind="LeadFormOsStep3c.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormOsStep3c" %>
<script>
  ...
  <div class="form-step active">
    <div class="form-step-container">
      <div class="form-step-controls pb-4">
        ...
        <div class="confirm-btn-div" style="max-width: 300px; margin: auto;">
        <asp:Button
          ID="BTNConfirmAppt"
          runat="server"
          class="btn-next mt-3"
