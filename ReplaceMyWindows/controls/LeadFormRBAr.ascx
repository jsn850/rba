...
CodeBehind="LeadFormRBAr.ascx.cs"
Inherits="ReplaceMyWindows.controls.LeadFormRBAr" %>
<asp:HiddenField
  id="leadid_token"
  value=""
  runat="server"
...
<div class="forms pt-3 pb-3 py-md-3">
  <div class="form-step active">
    ...
    <div class="form-step-container">
      ...
      <div class="form-step-title">
        To get started, enter the location of your project.
      </div>
      ...
      <div class="form-step-actions row no-gutters px-3 px-md-5">
        <asp:Button
          ...
          onClientClick="CheckZipShowAppt();"
        ></asp:Button
  ...
  <div class="form-step">
    <div class="form-step-container">
      ...
      <div class="form-step-subtitle">
        Now Offering 100% Virtual Appointments.
      </div>
      <div class="form-step-controls">
        <asp:RadioButton
          runat="server"
          ID="InHome"
          GroupName="ConsultType"
          CssClass="txt"
          ValidationGroup="LeadFormc"
          Checked="true"
        >
        </asp:RadioButton
        ...
        ><span class=""> Virtual (where available)</span>
      </div>
      <br />
      <br />
      <div class="form-step-actions row no-gutters px-3 px-md-5">
        ...
        <asp:Button
          ...
          class="col btn btn-primary btn-next"
          Text="Next"
          OnClientClick="gtag('event','click',{'event_category':'MPAGE','event_label':'ConsultType'});"
        ></asp:Button
        ><span class="arrow"></span>
      </div>
    </div>
  ...
  <div class="form-step">
    <div class="form-step-container">
      ...
      <div class="form-step-controls px-3 px-md-5">
        ...
        <div class="row no-gutters px-3 px-md-5">
        <asp:Button
          runat="server"
          ID="btnSubmit"
      ...
      <div class="tcpa mt-10">
        ...
        <p class="info" id="TCPAExpert" runat="server" visible="false">
          By pressing the Get Started Now button above, I agree to be contacted
          by Expert Windows, its partners and affiliates at the phone number and
          email address provided above which I certify is my own, through the
          use of automated technology including but not limited to SMS,
          artificial voice, pre-recorded message and email, for appointment
          scheduling, marketing materials and informational messages, and other
          offers and advertisements. You acknowledge that you are submitting
          this form so that you can be contacted via email, phone or text
          message and informed about products, services and sales, as well as
          third-party offers including, without limitation, from our affiliates
          and/or unrelated third parties. I understand that I am not required to
          provide consent in order to schedule an appointment or to receive
          goods or services. If I do not wish to provide this consent, I may
          contact you directly at (516) 253-6644.
        </p>
      </div>
      <%--
      <div class="form-step-actions row no-gutters px-3 px-md-5">
