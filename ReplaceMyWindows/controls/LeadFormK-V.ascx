<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormK-V.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormK_V" %>
...
<div class="bannerRight">
     ...
     <asp:TextBox runat="server" Text="" CssClass="" placeholder="First Name" ToolTip="First Name" ID="txtFirstName" MaxLength="80" ValidationGroup="LeadForm" ></asp:TextBox>
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Email is required." ValidationGroup="LeadForm"
                   ControlToValidate="txtEmail" Display="Dynamic" CssClass="req" InitialValue=""></asp:RequiredFieldValidator>
						...
						<div class="form-control phone">
							              <asp:TextBox runat="server" CssClass="" ID="txtPhone" MaxLength="14" placeholder="Phone Number" ToolTip="Phone Number" ValidationGroup="LeadForm"></asp:TextBox>
		...
		<%--				<div class="form-control Street">
							           <asp:TextBox runat="server" Text="" CssClass="" ID="txtStreet" ValidationGroup="LeadForm" placeholder="Street Address" ToolTip="Street Address"></asp:TextBox>
     ...
     <div class="form-row">              
               <div class="col-12 mb-0 mt-0 text-center label pt-3" style="padding-bottom:10px;">
  <label class="lbl">
  ...
  <asp:Button runat="server" ID="btnSubmit" Text="Schedule a Free Estimate" CssClass="button" BackColor="Orange" ForeColor="white" Font-Size="18" Font-Bold="true"   OnClick="btnSubmit_Click" ValidationGroup="LeadForm"
   UseSubmitBehavior="false" OnClientClick="disableBtn(this);" />
					
					<div  style="float: none;display: inline; white-space: nowrap;">
								     <img src="images/LOGO%20Certifed%20Master%20Installer%20TP.png"  alt="Certifed Master Installer"  width="80" class="MobileHidden"/>
