...
{
    public partial class LeadFormOSStep2test : System.Web.UI.UserControl
    {
        FormClass f = new FormClass();
        FormProperties fp = new FormProperties();
        public int Locationid = 0;

        public string WindowsDoorsMessage {  get; set; } 
        ...
        {
            WindowsDoorsMessage = string.Empty;
            ...
            if (!IsPostBack)
            {
                ...
                catch (Exception osex2)
                {
                    ...
                    Response.Redirect("Rbaw40-OStest.aspx");  //redirect to step 1 if we dont have leadid or intial insert fails
                }
            }
        ...
        protected void btnAddtlQuest_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Rbaw40-OS3test.aspx");
            }
        } catch(Exception ex) {
                    f.saveResponseLog("Error: " + ex.Message);
                }
}
