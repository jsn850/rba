<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormM.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormM" %>
<asp:HiddenField id="leadid_token"  value="" runat="server" ClientIDMode="Static"/>
            ...
            <div class="forms pt-3 pb-3 py-md-7">
                ...
                <div class="form-step active">
                    <div  class="form-bg-image" id="fbg1" runat="server"><img id="imgstep1" runat="server" src="img/hero-rbam-blackfriday.jpg"></div>
                ...
                <asp:CustomValidator ID="CustomValidatorZip" runat="server"    ControlToValidate="txtZipCode" Display="Dynamic" CssClass="form-error"   ValidationGroup="Group1" errormessage="Invalid ZipCode Entered" 
                    ClientValidationFunction="isValidZip"  EnableClientScript="true" ValidateEmptyText="false" ClientIDMode="Static" />
	                    ...
	                    <asp:Button runat="server" ID="ZipButton" ValidationGroup="Group1"   CssClass="col btn btn-primary btn-next" Text="START FREE QUOTE" onClientClick ="CheckZipShowAppt();"  ></asp:Button><span class="arrow"></span>
                ...
                <div class="form-step">
                    <div class="form-bg-image"><img id="imgstep3" runat="server" src="../img/hero3.jpg"></div>
                    <div class="form-step-container">
