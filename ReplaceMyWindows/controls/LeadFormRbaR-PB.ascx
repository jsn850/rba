<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeadFormRbaR-PB.ascx.cs" Inherits="ReplaceMyWindows.controls.LeadFormRbaR_PB" %>
 <asp:HiddenField id="leadid_token"  value="" runat="server" ClientIDMode="Static"/>
					...
					<div class="forms pt-3 pb-3 py-md-3">
						<div class="form-step active">
							...
							<div class="form-step-container">
	                         <div class="step-loader"><img src="images/loader-4step-1.png" width="80%" alt="20%"></div>
								
								<div class="form-step-title">To get started, enter the location of your project.</div>
						
								<div class="form-step-controls px-3 px-md-5">

                                         <asp:TextBox runat="server"   placeholder="Zip Code" ToolTip="Zip Code" type="tel" CssClass="form-control" Width="200" ID="txtZipCode" MaxLength="5" ValidationGroup="Group1" ></asp:TextBox>
  ...
  <%--           <div class="form-step">
				...
				<ul class="form-step-count">
					                <li><span class="disc">1</span><p>Enter Zip</p></li>
									<li><span class="disc">2</span><p>Add Details</p></li>
									<li><span class="disc">3</span><p>Find a Pro</p></li>
								</ul>
                ...
                <div class="form-step">
                    ...
                    <div class="form-step-container">
	                         <div class="step-loader"><img src="images/loader-4step-2.png" width="80%" alt="20%"></div>
                ...
                <div class="form-step">
                    ...
                    <div class="form-step-container">
	                         <div class="step-loader"><img src="images/loader-4step-3.png" width="80%" alt="20%"></div>
                ...
                <div class="form-step">
                    ...
                    <div class="form-step-container">
	                         <div class="step-loader"><img src="images/loader-4step-4.png" width="80%" alt="20%"></div>
